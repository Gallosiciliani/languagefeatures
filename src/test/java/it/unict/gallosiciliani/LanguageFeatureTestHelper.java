...
public class LanguageFeatureTestHelper {
    ...
    /**
     * Create a helper to test the i-th transformation for the feature with the given code
     *
     * @param featureCode feature code
     * @param i i-th transformation found with code featureCode
     * @return a test helper for i-th transformation for feature with code featureCode
     * @throws IllegalArgumentException if no such transformation exists.
     */
//    public static GIKBTransformationTestHelper build(final GIKBPhoneticFeatureCode featureCode, final int i){
//        final LanguageFeatureTransformation[] T = GIKBFeatureTransformations.build();
//        for(int j=0; j<T.length; j++)
//            if (featureCode.name().equals(T[j].toString())){
//                final LanguageFeatureTransformation t = T[j+i];
//                if (featureCode.name().equals(t.toString()))
//                    return new GIKBTransformationTestHelper(t);
//                throw new IllegalArgumentException(i+"th transformation feature after the first with code "+featureCode+" has feature code "+t);
//            }
//        throw new IllegalArgumentException("No transformation relative to "+featureCode);
//    }

//    /**
//     * Create a helper to test the transformation associated with the feature with the given code
//     *
//     * @param featureCode feature code
//     * @return a test helper for i-th transformation for feature with code featureCode
//     * @throws IllegalArgumentException if no such transformation exists.
//     */
//    public static GIKBTransformationTestHelper build(final GIKBPhoneticFeatureCode featureCode){
//        return build(featureCode, 0);
//    }
