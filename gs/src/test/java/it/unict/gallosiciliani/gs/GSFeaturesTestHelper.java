 ...
 */
public class GSFeaturesTestHelper {
     ...
     */
    public GSFeaturesTestHelper(final LinguisticPhenomenon t){
        this.t=t;
    }
     ...
     * @return this helper
     */
    public GSFeaturesTestHelper notApply(final String src){
     ...
     * @return this object
     */
    public GSFeaturesTestHelper derives(final String src, final String...expected){
     ...
     */
    public GSFeaturesTestHelper precededByVowelExt(final char srcChar1, final char srcChar2, final String replacement){
     ...
     */
    public GSFeaturesTestHelper lenitionFollowedByR(final char srcChar, final char destChar){
     ...
     * @param destChar corresponding character in the replacement string
     */
    public GSFeaturesTestHelper lenition(final char srcChar, final char destChar){
...
*/
     ...
     */
    public GSFeaturesTestHelper inOpenSyllable(final char srcVowel, final String...replacements){
        notApply("123XY456");
