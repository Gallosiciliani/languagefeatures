...
public class SPARQLRestController {
    ...
    public String urlEncodedPostQueryCSV(final SPARQLQueryForm form) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format text/csv", form.getQuery());
        return sparqlService.query(form.getQuery(), ResultsFormat.FMT_RS_CSV);
    }

    @PostMapping(value={"","/"}, consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = "application/sparql-results+xml")
    public String urlEncodedPostQueryXML(final SPARQLQueryForm form) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format application/sparql-results+xml", form.getQuery());
        return sparqlService.query(form.getQuery(), ResultsFormat.FMT_RS_XML);
    }

    @PostMapping(value={"","/"}, consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE, produces = "application/sparql-results+json")
    public String urlEncodedPostQueryJSON(final SPARQLQueryForm form) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format application/sparql-results+json", form.getQuery());
        return sparqlService.query(form.getQuery(), ResultsFormat.FMT_RS_JSON);
    }


    @GetMapping(value={"","/"}, produces = "text/csv")
    public String getQueryCSV(final @RequestParam String query) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format text/csv", query);
        return sparqlService.query(query, ResultsFormat.FMT_RS_CSV);
    }

    @GetMapping(value={"","/"}, produces = "application/sparql-results+xml")
    public String getQueryXML(final @RequestParam String query) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format application/sparql-results+xml", query);
        return sparqlService.query(query, ResultsFormat.FMT_RS_XML);
    }

    @GetMapping(value={"","/"}, produces = "application/sparql-results+json")
    public String getQueryJSON(final @RequestParam String query) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} with response format application/sparql-results+json", query);
        return sparqlService.query(query, ResultsFormat.FMT_RS_JSON);
    }

    @PostMapping(value={"","/"}, consumes = "application/sparql-query", produces = "text/csv")
    public String directPostQueryCSV(final @RequestBody String query) throws UnableToPerformSPARQLQueryException {
    ...
    public String directPostQueryXML(final @RequestBody String query) throws UnableToPerformSPARQLQueryException {
    ...
    public String directPostQueryJSON(final @RequestBody String query) throws UnableToPerformSPARQLQueryException {
        log.info("Performing SPARQL query {} using post direct with response format application/sparql-results+json", query);
        return sparqlService.query(query, ResultsFormat.FMT_RS_JSON);
    }

    @ExceptionHandler(value= UnableToPerformSPARQLQueryException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ModelAndView showQueryError(final UnableToPerformSPARQLQueryException e){
