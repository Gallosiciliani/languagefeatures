...
@Deprecated
public class LegacyDerivationsFinder {
...
//    private final DerivationBuilderWithStrategy derivationBuilder;
    ...
    LegacyDerivationsFinder(final String pdfFilePath, final int startPage, final int endPage) throws IOException {
    ...
    LegacyDerivationsFinder(final String entriesFilePath) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        final LegacyDerivationsFinder m=args[0].endsWith(".pdf") ? new LegacyDerivationsFinder(args[0],121, 1084) : new LegacyDerivationsFinder(args[0]);
